...
namespace ApigeeSDK.Unit.Tests
{
    public class GetCompaniesShould : ApigeeClientTestsBase
    {
        ...
        public void ReturnListOfCompaniesForValidJson()
        {
            ...
            string url = baseUri + $"/v1/o/{orgName}/companies?expand=true&count={entitiesLimit}";
        ...
        public void ReturnListOfCompaniesByPortions()
        {
            ...
            string urlForPortion1 = baseUri + $"/v1/o/{orgName}/companies?expand=true&count={testEntitiesLimit}";
            string urlForPortion2 = baseUri + $"/v1/o/{orgName}/companies?expand=true&count={testEntitiesLimit}&startKey=company-3";
        ...
        public void ThrowJsonSerializationExceptionIfJsonIsInvalid()
        {
            ...
            var apigeeService = this.GetInitializedApigeeService(
                baseUri + $"/v1/o/{orgName}/companies?expand=true&count={entitiesLimit}",
                invalidJson);
